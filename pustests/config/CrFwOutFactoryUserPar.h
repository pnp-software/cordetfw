 ...
 *
 * @brief User-modifiable parameters for the OutFactory component (see <code>CrFwOutFactory.h</code>).
 *
...
#define CR_FW_OUTCMP_INIT_KIND_DESC \
	...
	{1, 10, 0,   crRepType,   CRPS_REQVERIF_REROUT_FAIL_LENGTH,            &CrFwSmCheckAlwaysTrue,                       &CrFwSmCheckAlwaysTrue,                      &CrFwSmCheckAlwaysFalse,                      &CrFwSmEmptyAction,                              &CrFwOutCmpDefSerialize},\
      ...
      {13, 1, 0,   crRepType,   200,                        &CrPsLptDownFirstRepEnableCheck,              &CrFwSmCheckAlwaysTrue,                      &CrFwSmCheckAlwaysFalse,                      &CrPsLptDownFirstRepUpdateAction,                &CrFwOutCmpDefSerialize},\
      {13, 2, 0,   crRepType,   200,                        &CrPsLptDownInterRepEnableCheck,              &CrFwSmCheckAlwaysTrue,                      &CrPsLptDownInterRepRepeatCheck,              &CrPsLptDownInterRepUpdateAction,                &CrFwOutCmpDefSerialize},\
      {13, 3, 0,   crRepType,   200,                        &CrPsLptDownLastRepEnableCheck,               &CrFwSmCheckAlwaysTrue,                      &CrFwSmCheckAlwaysFalse,                      &CrPsLptDownLastRepUpdateAction,                 &CrFwOutCmpDefSerialize},\
