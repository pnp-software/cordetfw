...
\begin{figure}[ht]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{ServConcept.png}
...
\begin{figure}[ht]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{ServCmdRep.png}
...
\begin{figure}[ht]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{ServRerouting.png}
