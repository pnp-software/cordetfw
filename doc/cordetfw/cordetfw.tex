...
{
\pnpcsvtable[filter equal={\Category}{#1}]{|l|p{11.8cm}|}{#2}{tab:Req-#1}{\textbf{Req. ID} & \textbf{Requirement Text}}{CordetFwReq.csv}{P-\Category-\Id/\Type & \textit{\Text}}
}
...
{
\pnpcsvtable[filter equal={\Category}{#1}]{|l|p{4.7cm}|p{6.9cm}|}{#2}{tab:AP-#1}{\textbf{AP ID} & \textbf{Adaptation Point} & \textbf{Default Value}}{CordetFwAP.csv}{\Category-\Id & \AP  & \DefValue}
}
...
\hline
5.2.1 & Added logic to compute and set the CRC in OutComponents \\
\hline
6.2.2 & Added discussion of CRC check in the acceptance check of an InCommand or InReport \\
\hline
