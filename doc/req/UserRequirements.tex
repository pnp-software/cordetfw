...
\pnpcsvtable[filter not equal={\Category}{0}]{|l|p{4.2cm}|p{5.0cm}|p{8.4cm}|}{CORDET Adaptation Points}{tab:implCrFwAp}{\textbf{AP ID} & \textbf{Adaptation Point} & \textbf{Default Value} & \textbf{Implementation}}{../cordetfw/CordetFwAP.csv}{\Category-\Id & \AP & \DefValue & \CTwoImpl}
...
\pnpcsvtable[filter not equal={\CTwoCat}{0}]{|l|p{5.2cm}|p{13.0cm}|}{C2 Adaptation Points}{tab:implC2Ap}{\textbf{AP ID} & \textbf{Adaptation Point} & \textbf{Implementation}}{../cordetfw/CordetFwAP.csv}{\CTwoCat-\CTwoId & \AP & \CTwoImpl}
