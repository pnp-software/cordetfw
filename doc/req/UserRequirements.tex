...
\pnpcsvtable[filter equal={\Type}{S}]{|>{\centering\arraybackslash}p{0.9cm}|>{\raggedright}p{4.9cm}|p{6.9cm}|p{6.9cm}|}{Implementation of CORDET Framework Requirements}{tab:implCrFwReq}{\textbf{ID} & \textbf{Requirement Text} & \textbf{Requirement Implementation} & \textbf{Requirement Verification}}{../cordetfw/CordetFwReq.csv}{\Category-\Id & \Text & \Implementation & \Verification}
...
\pnpcsvtable[filter not equal={\Category}{0}]{|l|p{4.2cm}|p{5.0cm}|p{8.4cm}|}{CORDET Adaptation Points}{tab:implCrFwReq}{\textbf{AP ID} & \textbf{Adaptation Point} & \textbf{Default Value} & \textbf{Implementation}}{../cordetfw/CordetFwAP.csv}{\Category-\Id & \AP & \DefValue & \CTwoImpl}
...
\pnpcsvtable[filter not equal={\CTwoCat}{0}]{|l|p{5.2cm}|p{13.0cm}|}{C2 Adaptation Points}{tab:implCrFwReq}{\textbf{AP ID} & \textbf{Adaptation Point} & \textbf{Implementation}}{../cordetfw/CordetFwAP.csv}{\CTwoCat-\CTwoId & \AP & \CTwoImpl}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{ApplicationSM.png}
