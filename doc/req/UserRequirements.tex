...
\SetDocIssue{2.0}
\SetDocRefNumber{PP-SP-COR-0002}
\SetDocTitle{The CORDET Framework}
\SetDocSubtitle{User Requirements}
...
\pnpcsvtable[filter equal={\Kind}{S}]{|>{\centering\arraybackslash}p{0.9cm}|>{\raggedright}p{4.9cm}|p{6.9cm}|p{6.9cm}|}{Implementation of CORDET Framework Requirements}{tab:implCrFwReq}{\textbf{ID} & \textbf{Requirement Text} & \textbf{Requirement Implementation} & \textbf{Requirement Verification}}{../cordetfw/CrFwRequirement.csv}{\Domain-\Name & \Text & \Implementation & \Verification}
...
\pnpcsvtable[filter equal={\Kind}{SPC}]{|l|p{4.2cm}|p{5.0cm}|p{8.4cm}|}{CORDET Adaptation Points}{tab:implCrFwAp}{\textbf{AP ID} & \textbf{Adaptation Point} & \textbf{Default Value} & \textbf{Implementation}}{../cordetfw/CrFwAdaptPoint.csv}{\Domain-\Name & \Title & \DefaultValue & \Implementation}
...
\chgC{
This section has been deleted (C2 adaptation points have been moved to the specification level and are not covered in section \ref{sec:implCrFwAp}.
}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{AppSM.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.4,keepaspectratio=true]{OutStream.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{OutComponent.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{OutManagerExecution.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{RegistryStartTrackingAndUpdate.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{EnableStateDetermination.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{InLoaderExecution.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{InCommand.png}
...
\begin{figure}[h]
 \centering
 \includegraphics[scale=0.45,keepaspectratio=true]{InReportExecution.png}
