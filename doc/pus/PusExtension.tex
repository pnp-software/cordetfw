...
\pnpcsvtable[filter equal={\Domain}{Mon}]{|p{3cm}|>{\raggedright\arraybackslash}p{9.0cm}|}{Observables for Service 12 (On-Board Monitoring)}{tab:Obs-S12}{Name & Description}{Datapool.csv}{\texttt{\Name} & \ShortDesc}
