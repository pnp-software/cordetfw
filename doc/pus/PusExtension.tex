...
\hline
\texttt{MON\FAILED} & The number of parameter monitors in the functional monitor which reporterd a monitoring violation is greater than or eqaul to the minimum failing number  \\
\hline
\end{pnptable}  
...
\pnpcsvtable[separator=comma]{|c|>{\raggedright\arraybackslash}p{3.0cm}|>{\raggedright\arraybackslash}p{7cm}|c|>{\raggedright\arraybackslash}p{7cm}|}{Mapping of PUS Requirements to CORDET Requirement}{tab:mappingPusToCr}{N & Title & Requirement & C & Justification}{PusCompliance.csv}{\ReqN & \ReqTitle & \ReqText & \Status & \Justification}
