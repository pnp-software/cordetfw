...
Table \ref{tab:supportedPus} lists the command and report components provided by the PUS Extension of the CORDET Framework to support the PUS services. The first column in the table gives the command or report type and sub=type; the second column gives the name of the CORDET component which implements the command or report; the last column gives its PUS names as it is given in section 8 of [PS-SP]. Note that, in some cases, the same CORDET components implements two PUS commands or reports. This is the case where the two commands or reports share the same behaviour and only differ for the value of some of their attributes (e.g. the (3,25) and (3,26) reports).
...
\begin{itemize}
\item Services 13 and 12 generate event reports and therefore need service 5
\end{itemize}
...
Tables \ref{tab:MonEnbParMonDefCmdSpec} to \ref{tab:MonRepFuncMonStatRepSpec} . 

\input{GeneratedTables/CrPs_MonEnbParMonDefCmd_Spec.tex}
\printMonEnbParMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDisParMonDefCmd_Spec.tex}
\printMonDisParMonDefCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonChgTransDelCmd_Spec.tex}
\printMonChgTransDelCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDelAllParMonCmd_Spec.tex}
\printMonDelAllParMonCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonAddParMonDefCmd_Spec.tex}
\printMonAddParMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDelParMonDefCmd_Spec.tex}
\printMonDelParMonDefCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonModParMonDefCmd_Spec.tex}
\printMonModParMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonRepParMonDefCmd_Spec.tex}
\printMonRepParMonDefCmdSpec{|c|p{10cm}|}


\newpage
\input{GeneratedTables/CrPs_MonRepParMonDefRep_Spec.tex}
\printMonRepParMonDefRepSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonRepOutOfLimitsCmd_Spec.tex}
\printMonRepOutOfLimitsCmdSpec{|c|p{10cm}|}
 
\newpage
\input{GeneratedTables/CrPs_MonRepOutOfLimitsRep_Spec.tex}
\printMonRepOutOfLimitsRepSpec{|c|p{10cm}|}


\input{GeneratedTables/CrPs_MonCheckTransRep_Spec.tex}
\printMonCheckTransRepSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonRepParMonStatCmd_Spec.tex}
\printMonRepParMonStatCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonRepParMonStatRep_Spec.tex}
\printMonRepParMonStatRepSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonEnbParMonFuncCmd_Spec.tex}
\printMonEnbParMonFuncCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDisParMonFuncCmd_Spec.tex}
\printMonDisParMonFuncCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonEnbFuncMonCmd_Spec.tex}
\printMonEnbFuncMonCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDisFuncMonCmd_Spec.tex}
\printMonDisFuncMonCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonEnbFuncMonDefCmd_Spec.tex}
\printMonEnbFuncMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDisFuncMonDefCmd_Spec.tex}
\printMonDisFuncMonDefCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonProtFuncMonDefCmd_Spec.tex}
\printMonProtFuncMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonUnprotFuncMonDefCmd_Spec.tex}
\printMonUnprotFuncMonDefCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonAddFuncMonDefCmd_Spec.tex}
\printMonAddFuncMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonDelFuncMonDefCmd_Spec.tex}
\printMonDelFuncMonDefCmdSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonRepFuncMonDefCmd_Spec.tex}
\printMonRepFuncMonDefCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonRepFuncMonDefRep_Spec.tex}
\printMonRepFuncMonDefRepSpec{|c|p{10cm}|}

\newpage
\input{GeneratedTables/CrPs_MonRepFuncMonStatCmd_Spec.tex}
\printMonRepFuncMonStatCmdSpec{|c|p{10cm}|}

\input{GeneratedTables/CrPs_MonRepFuncMonStatRep_Spec.tex}
