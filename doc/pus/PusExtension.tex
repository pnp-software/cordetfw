...
\begin{itemize}
\item If the destination of the embedded command is not the host application, then the instruction containing the embedded command is rejected and a (1,4) report will be generated for it.
