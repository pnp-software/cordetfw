...
\hline
\texttt{period} & Collection period in units of HK\_COLLECT\_PER & Non-negative integer (a value of zero indicates a "one-shot" report) \\
\hline
...
\begin{fw_itemize}
\item Component HkCreate implements commands (3,1) and (3,2) to create a new report 
\item Component HkDelete implements commands (3,3) and (3,4) to delete a report 
\item TBD
\end{fw_itemize}
...
\begin{cr_ap}{S3-1}{Adaptation Points for HkCreate Command (3,1) and (3,2)}
\end{cr_ap}

\begin{cr_ap}{S3-3}{Adaptation Points for HkDelete Command (3,3) and (3,4)}
\end{cr_ap}
