...
\begin{pnptable}{#1}{Specification of VerSuccAccRep Component}{tab:VerSuccAccRepSpec}{Name & VerSuccAccRep}
Description & Service 1 Successful Acceptance Verification Report \\\hline
...
\begin{pnptable}{#1}{Specification of VerFailedAccRep Component}{tab:VerFailedAccRepSpec}{Name & VerFailedAccRep}
Description & Service 1 Failed Acceptance Verification Report \\\hline
...
\begin{pnptable}{#1}{Specification of VerSuccStartRep Component}{tab:VerSuccStartRepSpec}{Name & VerSuccStartRep}
...
\begin{pnptable}{#1}{Specification of VerFailedStartRep Component}{tab:VerFailedStartRepSpec}{Name & VerFailedStartRep}
Description & Verification report for failure of start of execution \\\hline
Parameters & Packet version number followed by information on the command being acknowledged: packet identifier, packet sequence counter, type, sub-type and discriminant, failure code and one single item of failure data (specific to each failure code).   \\\hline
Discriminant & None \\\hline
Enable Check & Service 1 reports retrieve their enable status from the OurRegistry as a function of their type, sub-type and discriminant \\\hline
Ready Check & Service 1 reports are always ready \\\hline
...
\begin{pnptable}{#1}{Specification of VerSuccPrgrRep Component}{tab:VerSuccPrgrRepSpec}{Name & VerSuccPrgrRep}
Description & Service 1 verification reports \\\hline
Parameters & Parameter values are as defined by the service 1 procedures called in adaptation points S1-1 to S1-9 \\\hline
Discriminant & None \\\hline
Enable Check & Service 1 reports retrieve their enable status from the OurRegistry as a function of their type, sub-type and discriminant \\\hline
...
\begin{pnptable}{#1}{Specification of VerFailedPrgrRep Component}{tab:VerFailedPrgrRepSpec}{Name & VerFailedPrgrRep}
Description & Verification report for failure of progress execution \\\hline
...
\begin{pnptable}{#1}{Specification of VerSuccTermRep Component}{tab:VerSuccTermRepSpec}{Name & VerSuccTermRep}
Description & Service 1 verification reports \\\hline
Parameters & Parameter values are as defined by the service 1 procedures called in adaptation points S1-1 to S1-9 \\\hline
Discriminant & None \\\hline
Enable Check & Service 1 reports retrieve their enable status from the OurRegistry as a function of their type, sub-type and discriminant \\\hline
...
\begin{pnptable}{#1}{Specification of VerFailedTermRep Component}{tab:VerFailedTermRepSpec}{Name & VerFailedTermRep}
Description & Verification report for a failure of termination of command execution \\\hline
Parameters & Packet version number followed by information on the command being acknowledged: packet identifier, packet sequence counter, type, sub-type and discriminant, failure code and one single item of failure data (specific to each failure code).   \\\hline
Discriminant & None \\\hline
Enable Check & Service 1 reports retrieve their enable status from the OurRegistry as a function of their type, sub-type and discriminant \\\hline
Ready Check & Service 1 reports are always ready \\\hline
...
\begin{pnptable}{#1}{Specification of VerFailedRoutingRep Component}{tab:VerFailedRoutingRepSpec}{Name & VerFailedRoutingRep}
Description & Service 1 verification reports \\\hline
Parameters & Parameter values are as defined by the service 1 procedures called in adaptation points S1-1 to S1-9 \\\hline
Discriminant & None \\\hline
Enable Check & Service 1 reports retrieve their enable status from the OurRegistry as a function of their type, sub-type and discriminant \\\hline
...
\begin{pnptable}{#1}{Specification of HkCreateHkCmd Component}{tab:HkCreateHkCmdSpec}{Name & HkCreateHkCmd}
Description & Command (3,1) to create a diagnostic report structure \\\hline
...
\begin{pnptable}{#1}{Specification of HkCreateDiagCmd Component}{tab:HkCreateDiagCmdSpec}{Name & HkCreateDiagCmd}
Description & Command (3,2) to create a diagnostic report structure \\\hline
...
\begin{pnptable}{#1}{Specification of HkDelHkCmd Component}{tab:HkDelHkCmdSpec}{Name & HkDelHkCmd}
Description & Command (3,3) to delete a housekeeping report definition \\\hline
...
\begin{pnptable}{#1}{Specification of HkDelDiagCmd Component}{tab:HkDelDiagCmdSpec}{Name & HkDelDiagCmd}
Description & Command (3,4) to delete a diagnostic report definition \\\hline
Parameters & List of SIDs of reports whose definition is to be deleted \\\hline
Discriminant & None \\\hline
Ready Check & Default implementation (command is always ready) \\\hline
Start Action & Run the procedure of \ref{fig:Cmd3s3Start} to identify the valid SIDs in the command argument \\\hline
...
\begin{pnptable}{#1}{Specification of HkEnableHkCmd Component}{tab:HkEnableHkCmdSpec}{Name & HkEnableHkCmd}
Description & Command (3,5) to Enable Periodic Generation of a Housekeeping Report Structure \\\hline
...
\begin{pnptable}{#1}{Specification of HkDisableHkCmd Component}{tab:HkDisableHkCmdSpec}{Name & HkDisableHkCmd}
Description & Command (3,6) to Disable Periodic Generation of a\newline Housekeeping Report Structure \\\hline
...
\begin{pnptable}{#1}{Specification of HkEnableDiagCmd Component}{tab:HkEnableDiagCmdSpec}{Name & HkEnableDiagCmd}
Description & Command (3,7) to Enable Periodic Generation of a Diagnostic Report Structure \\\hline
Parameters & List of SIDs to be enabled  \\\hline
Discriminant & None \\\hline
Ready Check & Default implementation (command is always ready) \\\hline
Start Action & Run the procedure Start Action of Multi-SID Command of figure \ref{fig:Cmd3SidStart} \\\hline
...
\begin{pnptable}{#1}{Specification of HkDisableDiagCmd Component}{tab:HkDisableDiagCmdSpec}{Name & HkDisableDiagCmd}
Description & Command (3,8) to Disable Periodic Generation of a Diagnostic Report Structure \\\hline
Parameters & List of SIDs to be disabled  \\\hline
Discriminant & None \\\hline
Ready Check & Default implementation (command is always ready) \\\hline
Start Action & Run the procedure Start Action of Multi-SID Command of figure \ref{fig:Cmd3SidStart} \\\hline
...
\begin{pnptable}{#1}{Specification of HkRepStructHkCmd Component}{tab:HkRepStructHkCmdSpec}{Name & HkRepStructHkCmd}
Description & Command (3,9) to Report Structure of a Housekeeping Report \\\hline
...
\begin{pnptable}{#1}{Specification of HkRepStructHkRep Component}{tab:HkRepStructHkRepSpec}{Name & HkRepStructHkRep}
Description & Report (3,10) to report the structure of a housekeeping report \\\hline
...
\begin{pnptable}{#1}{Specification of HkRepStructDiagCmd Component}{tab:HkRepStructDiagCmdSpec}{Name & HkRepStructDiagCmd}
Description & Command (3,11) to Report Structure of a Diagnostic Report \\\hline
Parameters & List of SIDs whose structure is to be reported \\\hline
Discriminant & None \\\hline
Ready Check & Default implementation (command is always ready) \\\hline
Start Action & Run the procedure Start Action of Multi-SID Command of figure \ref{fig:Cmd3SidStart} \\\hline
...
\begin{pnptable}{#1}{Specification of HkRepStructDiagRep Component}{tab:HkRepStructDiagRepSpec}{Name & HkRepStructDiagRep}
Description & Report (3,12) to report the structure of a diagnostic report \\\hline
...
Description & Periodic Housekeeping Report (3,25) \\\hline
...
\begin{pnptable}{#1}{Specification of HkDiagRep Component}{tab:HkDiagRepSpec}{Name & HkDiagRep}
...
\begin{pnptable}{#1}{Specification of HkOneShotHkCmd Component}{tab:HkOneShotHkCmdSpec}{Name & HkOneShotHkCmd}
...
\begin{pnptable}{#1}{Specification of EvtRep3 Component}{tab:EvtRepcSpec}{Name & EvtRep3}
Description & Event Report of Type (5,3) \\\hline
Parameters & Event Identifier (EID) acting as discriminant followed by event-specific parameters \\\hline
Discriminant & None \\\hline
Enable Check & Update service 5 observable nOfDetectedEvt x ('x' is the event severity level) and then retrieve the enable status from the Our-Registry as a function of the report type, sub-type and discriminant \\\hline
Ready Check & Default implementation (report is always ready) \\\hline
...
Description & Report (5,8) to report the list of disabled Event Identifiers \\\hline
...
\begin{pnptable}{#1}{Specification of LptStartDownCmd Component}{tab:LptStartDownCmdSpec}{Name & LptStartDownCmd}
